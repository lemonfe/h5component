...
var _H5ComponentBase = __webpack_require__(0);
...
function H5ComponentPie(name, cfg) {
  var component = new _H5ComponentBase2.default(name, cfg);
  //绘制网格线
  var w = cfg.width;
  var h = cfg.height;
  //加入一个画布
...
$(function () {
  ...
  h5.addPage('face').addComponent('topic', {
    ...
    width: 630,
    height: 300,
    data: [['js', .4, '#ff7676'], ['html', .2, '#ff7676'], ['css', .3, '#ff7676'], ['vue', .05, '#ff7676'], ['react', .09, '#ff7676']],
    css: {
      opacity: 0,
      top: 100
    },
    ...
    width: 400,
    height: 400,
    data: [['js', .4, '#ff7676'], ['html', .2, '#f6f'], ['css', .15, '#aaa'], ['vue', .05, '#f00'], ['react', .2, 'blue']],
    css: {
      opacity: 0,
      top: 200
    },
    ...
    width: 530,
    height: 600,
    data: [['js', .4, '#ff7676'], ['html', .2], ['css', .3], ['vue', .05], ['react', .09]],
    css: {
      opacity: 0,
      top: 100
    },
    ...
    width: 400,
    height: 400,
    data: [['js', .9, '#ff7676'], ['html', .6, '#ff7676'], ['css', .5, '#ff7676'], ['vue', .8, '#ff7676'], ['react', .2, '#ff7676']],
    css: {
      opacity: 0,
      top: 100
    },
    ...
    width: 300,
    height: 300,
    data: [['A项', .4, 'green'], ['B项', .2, 'yellow', 0, '-60%'], ['C项', .3, 'red', 0, '120%']],
    css: {
      bottom: '40%'
    },
    center: true
...
var _H5ComponentBar = __webpack_require__(4);

var _H5ComponentBar2 = _interopRequireDefault(_H5ComponentBar);

var _H5ComponentPoint = __webpack_require__(5);

var _H5ComponentPoint2 = _interopRequireDefault(_H5ComponentPoint);

var _H5ComponentPie = __webpack_require__(1);
...
var _H5ComponentRadar = __webpack_require__(7);

var _H5ComponentRadar2 = _interopRequireDefault(_H5ComponentRadar);

var _H5ComponentRing = __webpack_require__(8);

var _H5ComponentRing2 = _interopRequireDefault(_H5ComponentRing);
  ...
  this.addComponent = function (name, cfg) {
    ...
    switch (cfg.type) {
      case 'base':
        ...
        break;
      case 'polyline':
        component = new _H5ComponentPolyLine2.default(name, cfg);
        break;
      case 'pie':
        component = new _H5ComponentPie2.default(name, cfg);
        break;
      case 'bar':
        component = new _H5ComponentBar2.default(name, cfg);
        break;
      case 'radar':
        component = new _H5ComponentRadar2.default(name, cfg);
        break;
      case 'ring':
        component = new _H5ComponentRing2.default(name, cfg);
        break;
      case 'point':
        component = new _H5ComponentPoint2.default(name, cfg);
        break;
      default:
    }
...
exports.default = H5ComponentRadar;
...
exports.default = H5ComponentRing;
...
function H5ComponentRing(name, cfg) {
  ...
  cfg.type = 'pie';
  var component = new _H5ComponentPie2.default(name, cfg);
